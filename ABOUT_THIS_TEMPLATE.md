...
│
├───coninstruction             # The main python package for the project
...
You should create new files and subpackages inside coninstruction and implement your functionalities there. Remember to add what you write to `__init__.py` so that the imports work smoothly. Take a look at `base.py` and `__init__.py` to understand how it works.
