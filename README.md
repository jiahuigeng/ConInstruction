...
[![License](https://img.shields.io/github/license/jiahuigeng/ConInstruction)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/jiahuigeng/ConInstruction/actions/workflows/main.yml/badge.svg)](https://github.com/jiahuigeng/ConInstruction/actions/workflows/main.yml)
...
To import classes/methods of `coninstruction` from inside the package itself you can use relative imports: 
...
```py
from coninstruction import BaseClass # Notice how I omit the file name
from coninstruction.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `coninstruction` from command line:

```bash
$ python -m coninstruction
```
